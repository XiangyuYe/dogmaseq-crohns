...
senders_oi <- receivers_oi[grep("Treg", receivers_oi)]
...
lapply(c("TI", "Colon"), function(type){
  ...
  lapply(c("II_vs_NN", "NU_vs_NN"), function(contrast_name){
    ...
    ##### 4. plot from all Treg to each CD4 #####
    ## 4.1 up
    ...
    ##### 5. plot from all CD4 to each Treg #####
    ## 5.1 up
