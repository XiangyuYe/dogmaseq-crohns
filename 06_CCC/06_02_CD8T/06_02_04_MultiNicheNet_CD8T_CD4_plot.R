...
senders_oi <- all_ct[grep("^CD8", all_ct)]
...
lapply(c("TI", "Colon"), function(type){
  ...
  lapply(c("II_vs_NN", "NU_vs_NN"), function(contrast_name){
    ...
    ##### 4. plot from all CD8T to each CD4 #####
    ## 4.1 up
    ...
    ##### 5. plot from all CD4 to each CD8T #####
    ## 5.1 up
