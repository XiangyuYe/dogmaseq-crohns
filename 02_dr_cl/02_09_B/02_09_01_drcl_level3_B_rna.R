...
sc_meta_b <- subset(sc_meta_all, ann_level2_refine %in% c("B", "Plasma"))
scRNA_obj <- subset(scRNA_obj, cells = rownames(sc_meta_b))
scRNA_obj$ann_level2_refine <- sc_meta_b$ann_level2_refine %>% as.character()
...
out_path <- "03_output/03_clustering/B/"
