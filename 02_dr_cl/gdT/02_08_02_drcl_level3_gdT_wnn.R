...
setwd(project_path)
code_path <- "/ix1/wchen/xiangyu/Projects/03_CD_DOGMA/code/FUNCTION/"
...
data_path <- "03_output/03_clustering/gdT/"
out_path <- "03_output/03_clustering/gdT/WNN_ADT_RNA/"
sc_obj <- scRNA_obj <- readRDS(glue("{data_path}scRNA_obj_test.rds"))
...
#
sc_chromvar <- readRDS(glue("{data_path}scchromvar_assay_{cutoff_q}.rds")) %>%
