...
feature_list <- list(
  ...
  "Effect_features_list" = c("GZMK","GZMA", "GZMB", "GNLY","NKG7", "PDE4C", "PDE3B"),
...
##
sc_meta_ref <- readRDS("/ix1/wchen/xiangyu/Projects/03_CD_DOGMA/03_output/03_clustering_test/CD4_TRM/test302015/sc_meta.rds")
...
## temp anotation
sc_obj$ann_level4_temp1 <- "CD4_TRM_Th17"
sc_obj$ann_level4_temp1[sc_obj$wsnn_res.2 %in% c(0, 2, 6, 11, 17, 18)] <- "CD4_TRM_Th1"
sc_obj$ann_level4_temp1[sc_obj$wsnn_res.2 %in% c(4, 14, 15, 20, 21)] <- "CD4_TRM_Th17.1"
##
...
##### round 1 #####
##### round 1_1 #####
sc_obj_sub1_1 <- subset(sc_obj, cells = colnames(sc_obj)[sc_obj$ann_level4_temp1 == "CD4_TRM_Th17"])
...
## temp anotation
sc_obj_sub1_1$ann_level4_temp1_1 <- "Mixed"
sc_obj_sub1_1$ann_level4_temp1_1[sc_obj_sub1_1$wsnn_res.2 %in% c(2, 6, 18)] <- "CD4_TRM_Th17.1"
sc_obj_sub1_1$ann_level4_temp1_1[sc_obj_sub1_1$wsnn_res.2 %in% c(7, 12, 16)] <- "CD4_TRM_Th17"
sc_obj_sub1_1$ann_level4_temp1_1[sc_obj_sub1_1$wsnn_res.2 %in% c(8:10, 15)] <- "CD4_TRM"
...
## temp anotation
sc_obj_sub1_2$ann_level4_temp1_2 <- "CD4_TRM_Th17"
sc_obj_sub1_2$ann_level4_temp1_2[sc_obj_sub1_2$wsnn_res.2 %in% c(15, 17)] <- "CD4_TRM_Th17.1"
sc_obj_sub1_2$ann_level4_temp1_2[sc_obj_sub1_2$wsnn_res.2 %in% c(9, 10)] <- "CD4_TRM_Th1"
sc_obj_sub1_2$ann_level4_temp1_2[sc_obj_sub1_2$wsnn_res.2 %in% c(1, 16, 19)] <- "CD4_TRM"
...
##### round 2 #####
##### round 2_1 #####
sel_ct <- c("CD4_TRM", "CD4_TRM_Th1")
sc_obj_sub2_1 <- subset(sc_obj, cells = colnames(sc_obj)[sc_obj$ann_level4_temp1_2 %in% sel_ct])
...
## temp anotation
sc_obj_sub2_1$ann_level4_temp2_1 <- "CD4_TRM_Th1"
sc_obj_sub2_1$ann_level4_temp2_1[sc_obj_sub2_1$wsnn_res.2 %in% c(0, 6, 17:21)] <- "CD4_TRM_Th17.1"
sc_obj_sub2_1$ann_level4_temp2_1[sc_obj_sub2_1$wsnn_res.2 %in% c(9, 10, 13:15)] <- "CD4_TRM"
sc_obj$ann_level4_temp2_1 <- sc_obj$ann_level4_temp1_2
...
##### round 2_2 #####
sel_ct <- c("CD4_TRM", "CD4_TRM_Th17.1")
...
## temp anotation
sc_obj_sub2_2$ann_level4_temp2_2 <- "CD4_TRM_Th17.1"
sc_obj_sub2_2$ann_level4_temp2_2[sc_obj_sub2_2$wsnn_res.2 %in% c(0, 6, 7, 11:14, 18, 19, 23)] <- "CD4_TRM"
...
## temp anotation
sc_obj_sub2_3$ann_level4_temp2_3 <- "CD4_TRM_Th17"
sc_obj_sub2_3$ann_level4_temp2_3[sc_obj_sub2_3$wsnn_res.2 %in% c(5, 8)] <- "CD4_TRM"
sc_obj_sub2_3$ann_level4_temp2_3[sc_obj_sub2_3$wsnn_res.2 %in% c(1, 9, 11, 15:19)] <- "CD4_TRM_Th17.1"
sc_obj_sub2_3$ann_level4_temp2_3[sc_obj_sub2_3$wsnn_res.2 %in% c(12, 20, 21)] <- "CD4_TRM_Th1"
...
##### round 2_4 #####
sel_ct <- c("CD4_TRM_Th1", "CD4_TRM_Th17")
...
## temp anotation
sc_obj_sub2_4$ann_level4_temp2_4 <- "CD4_TRM_Th17"
sc_obj_sub2_4$ann_level4_temp2_4[sc_obj_sub2_4$wsnn_res.2 %in% c(1:3, 5, 7, 8, 13, 15:19, 21)] <- "CD4_TRM_Th1"
...
##### round 2_5 #####
sel_ct <- c("CD4_TRM_Th1", "CD4_TRM_Th17.1")
...
## temp anotation
sc_obj_sub2_5$ann_level4_temp2_5 <- "CD4_TRM_Th17.1"
sc_obj_sub2_5$ann_level4_temp2_5[sc_obj_sub2_5$wsnn_res.2 %in% c(1, 2, 4, 8, 10, 11, 18, 19)] <- "CD4_TRM_Th1"
...
##### round 2_6 #####
sel_ct <- c("CD4_TRM_Th17", "CD4_TRM_Th17.1")
sc_obj_sub2_6 <- subset(sc_obj, cells = colnames(sc_obj)[sc_obj$ann_level4_temp2_5 %in% sel_ct])
DefaultAssay(sc_obj_sub2_6) <- "RNA"
sc_obj_sub2_6 <- NormalizeData(sc_obj_sub2_6)
#
sc_obj_sub2_6 <- scsub.renorm(sc_obj = sc_obj_sub2_6,
                              ...
                              do_harmony = T,
                              batch_col = "Batch")
sc_obj_sub2_6 <- dr.cl.wnn(sc_obj = sc_obj_sub2_6,
                           redc_list = list("harmony_SCT", "harmony_lsi"),
                           dim_list = list(1:20, 1:10),
                           k_nn = 20,
                           prune_SNN = 1/20,
                           ...
                           seed_use = seed_use)
##
tiff(file = glue("{out_path}UMAP_sub2_6_ann_ref.tiff"),
     width = 8, height = 6, units = "in", res = 600, compression = "lzw")
DimPlot(subset(sc_obj_sub2_6, !is.na(ann_ref)),
        reduction = "wnn.umap",
        group.by = "ann_ref",
        cols = cols4all::c4a("rainbow", 14),
        raster = F,
...
dev.off()
##
dot_motif <- DotPlot(sc_obj_sub2_6, 
                     assay = "chromvar", 
                     col.min = -2,
                     col.max = 2,
                     features = sel_motif,
  ...
  scale_x_discrete(labels = names_motif) +
  theme(axis.text.x = element_text(angle = 90))
tiff(glue("{out_path}dot_raw_motif_sub2_6.tiff"), 
     height = 8, width = 5, units = "in", res = 300, compression = "lzw")
print(dot_motif)
dev.off()

## temp anotation
# uncertain clusters: 1, 
sc_obj_sub2_6$ann_level4_temp2_6 <- "Mixed"
sc_obj_sub2_6$ann_level4_temp2_6[sc_obj_sub2_6$wsnn_res.2 %in% c(6, 9, 11, 14, 18, 19, 21, 23)] <- "CD4_TRM_Th17.1"
sc_obj_sub2_6$ann_level4_temp2_6[sc_obj_sub2_6$wsnn_res.2 %in% c(1, 2:5, 7, 10, 15, 16, 20)] <- "CD4_TRM_Th17"
sc_obj$ann_level4_temp2_6 <- sc_obj$ann_level4_temp2_5
sc_obj$ann_level4_temp2_6[match(colnames(sc_obj_sub2_6), colnames(sc_obj))] <- sc_obj_sub2_6$ann_level4_temp2_6

##
tiff(file = glue("{out_path}UMAP_sub2_6_level4_ann.tiff"),
     width = 6, height = 6, units = "in", res = 600, compression = "lzw")
DimPlot(sc_obj_sub2_6, 
        reduction = "wnn.umap", 
        group.by = "ann_level4_temp2_6",
        label = T) + NoLegend()
dev.off()

##
tiff(file = glue("{out_path}UMAP_temp2_6_level4.tiff"),
     width = 6, height = 6, units = "in", res = 600, compression = "lzw")
DimPlot(sc_obj, 
        reduction = "wnn.umap", 
        group.by = "ann_level4_temp2_6",
...
##### round 2_7 #####
sel_ct <- c("CD4_TRM", "Mixed")
sc_obj_sub2_7 <- subset(sc_obj, cells = colnames(sc_obj)[sc_obj$ann_level4_temp2_6 %in% sel_ct])
DefaultAssay(sc_obj_sub2_7) <- "RNA"
sc_obj_sub2_7 <- NormalizeData(sc_obj_sub2_7)
#
sc_obj_sub2_7 <- scsub.renorm(sc_obj = sc_obj_sub2_7,
                              ...
                              do_harmony = T,
                              batch_col = "Batch")
sc_obj_sub2_7 <- dr.cl.wnn(sc_obj = sc_obj_sub2_7,
                           redc_list = list("harmony_SCT", "harmony_lsi"),
                           dim_list = list(1:20, 1:10),
                           k_nn = 20,
                           prune_SNN = 1/15,
                           ...
                           seed_use = seed_use)
##
tiff(file = glue("{out_path}UMAP_sub2_7_ann_ref.tiff"),
     width = 8, height = 6, units = "in", res = 600, compression = "lzw")
DimPlot(subset(sc_obj_sub2_7, !is.na(ann_ref)),
        reduction = "wnn.umap",
        group.by = "ann_ref",
        cols = cols4all::c4a("rainbow", 14),
        raster = F,
...
dev.off()
##
dot_motif <- DotPlot(sc_obj_sub2_7, 
                     assay = "chromvar", 
                     col.min = -2,
                     col.max = 2,
                     features = sel_motif,
  ...
  scale_x_discrete(labels = names_motif) +
  theme(axis.text.x = element_text(angle = 90))
tiff(glue("{out_path}dot_raw_motif_sub2_7.tiff"), 
     height = 8, width = 5, units = "in", res = 300, compression = "lzw")
print(dot_motif)
dev.off()

## temp anotation
sc_obj_sub2_7$ann_level4_temp2_7 <- "CD4_TRM_Th17"
sc_obj_sub2_7$ann_level4_temp2_7[sc_obj_sub2_7$wsnn_res.1 %in% c(4, 6, 8)] <- "CD4_TRM"
sc_obj_sub2_7$ann_level4_temp2_7[sc_obj_sub2_7$wsnn_res.1 %in% c(7)] <- "CD4_TRM_Th17.1"
sc_obj_sub2_7$ann_level4_temp2_7[sc_obj_sub2_7$wsnn_res.1 %in% c(2, 5, 9, 10, 12:14)] <- "CD4_TRM_Th1"
sc_obj$ann_level4_temp2_7 <- sc_obj$ann_level4_temp2_6
sc_obj$ann_level4_temp2_7[match(colnames(sc_obj_sub2_7), colnames(sc_obj))] <- sc_obj_sub2_7$ann_level4_temp2_7

##
tiff(file = glue("{out_path}UMAP_sub2_7_level4_ann.tiff"),
     width = 6, height = 6, units = "in", res = 600, compression = "lzw")
DimPlot(sc_obj_sub2_7, 
        reduction = "wnn.umap", 
        group.by = "ann_level4_temp2_7",
        label = T) + NoLegend()
dev.off()

##
tiff(file = glue("{out_path}UMAP_temp2_7_level4.tiff"),
     width = 6, height = 6, units = "in", res = 600, compression = "lzw")
DimPlot(sc_obj, 
        reduction = "wnn.umap", 
        group.by = "ann_level4_temp2_7",
...
##### round 3 #####
##### round 3_1 #####
sc_obj_sub3_1 <- subset(sc_obj, cells = colnames(sc_obj)[sc_obj$ann_level4_temp2_7 %in% c("CD4_TRM_Th1")])
...
tiff(file = glue("{out_path}UMAP_sub3_1_ann_ref.tiff"),
     width = 8, height = 6, units = "in", res = 600, compression = "lzw")
DimPlot(subset(sc_obj_sub3_1, !is.na(ann_ref)),
        reduction = "wnn.umap",
        group.by = "ann_ref",
        cols = cols4all::c4a("rainbow", 14),
        raster = F,
...
sc_obj_sub_test$ann_test <- sc_obj_sub_test$ann_level4_temp2_7
...
## temp anotation
sc_obj_sub3_1$ann_level4_temp3_1 <- "CD4_TRM_Th1"
sc_obj_sub3_1$ann_level4_temp3_1[sc_obj_sub3_1$wsnn_res.2 %in% c(17, 20, 23)] <- "CD4_TRM_Th17.1"
sc_obj$ann_level4_temp3_1 <- sc_obj$ann_level4_temp2_7
...
##### round 3_2 #####
sc_obj_sub3_2 <- subset(sc_obj, cells = colnames(sc_obj)[sc_obj$ann_level4_temp3_1 %in% c("CD4_TRM_Th17.1")])
...
## see in all-cell scale
sc_obj_sub_test <- sc_obj
sc_obj_sub_test$ann_test <- sc_obj_sub_test$ann_level4_temp3_1
sc_obj_sub_test$ann_test[match(colnames(sc_obj_sub3_2),
                               colnames(sc_obj_sub_test))] <- paste0("a", sc_obj_sub3_2$seurat_clusters)
dot_motif1 <- DotPlot(sc_obj_sub_test,
                      assay = "chromvar",
                      col.min = -2,
                      col.max = 2,
...
## temp anotation
sc_obj_sub3_2$ann_level4_temp3_2 <- "CD4_TRM_Th17.1"
sc_obj_sub3_2$ann_level4_temp3_2[sc_obj_sub3_2$wsnn_res.2 %in% c(6, 7, 16, 21, 24)] <- "CD4_TRM_Th17"
sc_obj_sub3_2$ann_level4_temp3_2[sc_obj_sub3_2$wsnn_res.2 %in% c(0, 8, 20, 23)] <- "CD4_TRM"
...
## temp anotation
sc_obj_sub3_3$ann_level4_temp3_3 <- "CD4_TRM_Th17"
sc_obj_sub3_3$ann_level4_temp3_3[sc_obj_sub3_3$wsnn_res.2 %in% c(12, 19)] <- "CD4_TRM"
sc_obj_sub3_3$ann_level4_temp3_3[sc_obj_sub3_3$wsnn_res.2 %in% c(4)] <- "CD4_TRM_Th1"
...
## temp anotation
sc_obj_sub3_4$ann_level4_temp3_4 <- "CD4_TRM_Th17.1"
sc_obj_sub3_4$ann_level4_temp3_4[sc_obj_sub3_4$wsnn_res.2 %in% c(23)] <- "CD4_TRM"
...
## temp anotation
sc_obj_sub3_5$ann_level4_temp3_5 <- "CD4_TRM_Th17"
...
## temp anotation
sc_obj_sub3_6$ann_level4_temp3_6 <- "CD4_TRM_Th1"
sc_obj_sub3_6$ann_level4_temp3_6[sc_obj_sub3_6$wsnn_res.2 %in% c(8, 14)] <- "CD4_TRM"
sc_obj_sub3_6$ann_level4_temp3_6[sc_obj_sub3_6$wsnn_res.2 %in% c(9, 15, 16)] <- "CD4_TRM_Th17"
...
## temp anotation
sc_obj_sub3_7$ann_level4_temp3_7 <- "CD4_TRM_Th17"
...
##### save anno level4 #####
sc_obj$ann_level4_final <- sc_obj$ann_level4_temp3_7
...
tiff(glue("{out_path}dot_rna_level4_final.tiff"), 
     height = 10, width = 15, units = "in", res = 300, compression = "lzw")
DotPlot(sc_obj, 
        assay = "RNA", 
        col.min = -2, 
        col.max = 2,  
