...
#SBATCH --job-name=dogma_qc2
#SBATCH --mem=20G
#SBATCH --cpus-per-task=20

#SBATCH --array=40-42
#SBATCH --output=/ix1/wchen/xiangyu/Projects/03_CD_DOGMA_test/00_temp/00_dogma_HTO%a.out
#SBATCH --error=/ix1/wchen/xiangyu/Projects/03_CD_DOGMA_test/00_temp/00_dogma_HTO%a.err
